...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginParams&&(identical(other.userid, userid) || other.userid == userid)&&(identical(other.password, password) || other.password == password));
}
...
class _LoginParams implements LoginParams {
  const _LoginParams({required this.userid, required this.password});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoginParams&&(identical(other.userid, userid) || other.userid == userid)&&(identical(other.password, password) || other.password == password));
}
